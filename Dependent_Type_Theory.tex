...
\]
\begin{tcolorbox}[breakable, colback=yellow!10!white,colframe=brown!75!black,title=Exercise 3.4.1.]\hypertarget{const 3.4.1.}{}
...
\inferrule
{
    \Gamma \vdash b : \mathbf{ Bool} \quad \Gamma.\mathbf{Bool} \vdash A \text{ type}
}
{
    \Gamma \vdash \mathbf{absurd}(b) : A[\mathbf{id}.b]
}
...
\inferrule
{
    \Gamma \vdash b \textbf{ Bool} \quad \Gamma.\mathbf{Bool} \vdash a : A 
}
{
...
However, 
\[\Gamma.\mathbf{Bool} \vdash \mathbf{Eq}(A[\mathbf{id}.b], \mathbf{absurd}(b), a[\mathbf{id}.b])[\mathbf{p}] \text{ type}\]
Then, this again implies that 
\[
\inferrule
{
    \Gamma \vdash b : \mathbf{Bool} \quad \Gamma.\mathbf{Bool} \vdash \mathbf{Eq}(A[\mathbf{id}.b], \mathbf{absurd}(b), a[\mathbf{id}.b])[\mathbf{p}] \text{ type}
}
{
    \Gamma \vdash \mathbf{absurd}(b) : \mathbf{Eq}(A[\mathbf{id}.b], \mathbf{absurd}(b), a[\mathbf{id}.b])
}
\]
Finally, this Extensional equality directly implies that 
\[\Gamma \vdash \mathbf{absurd}(b) = a[\mathbf{id}.b] : A[\mathbf{id}.b]\]
\end{proof}
